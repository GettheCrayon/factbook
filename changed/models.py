...
def upload_location(instance,filename):
	return '%s/%s/%s/%s'%( instance.folder.proj.user.email, instance.folder.proj, instance.folder, filename)
...
class Picture(models.Model):
	...
	def delete(self):
		...
		return super(Picture,self).delete()	
...
def upload_location(instance,filename):
	return '%s/%s/%s'%(User.email, instance.folder.proj, instance.folder)
